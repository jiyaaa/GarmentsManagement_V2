...
class Admin:
    ...
    def admin_mainmenu(self,a,b):
        ...
        # Replace 'your_script.py' with the name of the Python file you want to run.
         ...
         self.sales = Button(self.mainframe, text="Employees \n add or \n remove",bd=5,font="roboto 11 bold", image=mi, compound=TOP, command=run_another_file)
         self.sales.pack()
         self.sales.image = mi
         self.sales.place(x=444, y=27)
