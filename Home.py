...
class Main(Login,Admin,User):
    ...
    def buildmain(self):
        ...
        self.store_name = 'AJK Garments LTD '
        self.storelable=Label(self.topframe,text=self.store_name + " Management App",bg="#4267b2",anchor="center")
        self.storelable.config(font="Roboto 30 bold",fg="snow")
        self.storelable.place(x=360,y=50)
